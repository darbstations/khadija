...
AXIS_PARENT={
 ...
 ("marketing","الاكتساب والعائد"):"الاكتساب والعائد التسويقي",("marketing","الوعي والوصول"):"الوعي والوصول",("marketing","التفاعل والمجتمع"):"التفاعل والمجتمع",("marketing","السمعة وتجربة العلامة"):"السمعة وتجربة العلامة",("marketing","نمو تطبيق تانكي"):"نمو تطبيق تانكي",
 ...
 ("finance","المالية الاستراتيجية"):"الأداء المالي الاستراتيجي",("finance","الذمم المدينة"):"التحصيل وإدارة المدينين",("finance","صناعة الوقود"):"دقة مخزون وتسويات الوقود",("finance","الذمم الدائنة"):"إدارة الدائنين",("finance","تمويل الامتياز"):"تحصيل الامتياز",("finance","الموازنة والتقارير"):"انضباط الموازنة",("finance","السيولة ورأس المال"):"السيولة ورأس المال العامل"}
