...
AXIS_PARENT={
 ("operations","النمو والأداء والكفاءة التشغيلية"):"النمو والأداء والكفاءة التشغيلية",("operations","جودة التشغيل"):"جودة التشغيل",("operations","السلامة والتراخيص والامتثال"):"السلامة والتراخيص والامتثال",("operations","النظافة والبيئة والهوية البصرية"):"النظافة والبيئة والهوية البصرية",("operations","تجربة العميل والرضا"):"تجربة العميل والرضا",
