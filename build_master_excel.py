...
AXIS_PARENT={
 ...
 ("marketing","الحملات التسويقية"):"فاعلية الحملات",("marketing","العلاقات والشراكات"):"العلاقات والشراكات",("marketing","الفريق الإبداعي"):"المحتوى والتفاعل",("marketing","الإدارة العامة"):"الوصول واكتساب العملاء",("marketing","خدمة العملاء والدعم"):"خدمة العملاء",("marketing","تطبيق تانكي"):"نمو تطبيق تانكي",
 ...
 ("finance","المالية الاستراتيجية"):"الأداء المالي الاستراتيجي",("finance","الذمم المدينة"):"التحصيل وإدارة المدينين",("finance","صناعة الوقود"):"دقة مخزون وتسويات الوقود",("finance","الذمم الدائنة"):"إدارة الدائنين",("finance","تمويل الامتياز"):"تحصيل الامتياز",("finance","العقار والإيجار"):"تحصيل الإيجار",("finance","الموازنة والتقارير"):"انضباط الموازنة",("finance","السيولة ورأس المال"):"السيولة ورأس المال العامل"}
