...
# ترتيب مؤشرات كل إدارة بحيث تتجاور مؤشرات كل محور (بترتيب أول ظهور) — يمنع تشتّت
# الفرعيات بعيداً عن مؤشرها الأساسي في هيكلة المجموعات (outline).
def _axis_contiguous(records):
    order=[]; seen=[]
    for r in records:
        ax=r[0]
        if ax not in seen: seen.append(ax)
    for ax in seen:
        order.extend([r for r in records if r[0]==ax])
    return order
K.DEPARTMENTS=[(dn,key,_axis_contiguous(recs)) for dn,key,recs in K.DEPARTMENTS]
...
AXIS_PARENT={
 ("operations","النمو والأداء والكفاءة التشغيلية"):"النمو والأداء والكفاءة التشغيلية",("operations","جودة التشغيل"):"جودة التشغيل",("operations","السلامة والصحة المهنية"):"السلامة والصحة المهنية",("operations","البيئة والاستدامة"):"البيئة والاستدامة",("operations","النظافة والهوية البصرية"):"النظافة والهوية البصرية",("operations","تجربة العميل والرضا"):"تجربة العميل والرضا",
 ("realestate","التأجير والإشغال"):"التأجير والإشغال",("realestate","كفاءة التحصيل"):"كفاءة التحصيل",("realestate","تشغيل وخدمة الوحدات"):"تشغيل وخدمة الوحدات",("realestate","رضا واستبقاء المستأجرين"):"رضا واستبقاء المستأجرين",("realestate","ساحات درب"):"ساحات درب",
 ("investment","الفرص والنمو"):"نمو محفظة الاستثمار",("investment","العائد والربحية"):"عائد وربحية الاستثمار",("investment","الكفاءة التشغيلية"):"كفاءة دورة الاستثمار",("investment","الجودة الإدارية والامتثال"):"الجودة الإدارية والامتثال",
 ("exec","النمو"):"الأداء العام للنمو والتوسع",("exec","الابتكار"):"التحول الرقمي وإنجاز المشاريع",("exec","الاستدامة"):"الاستدامة ورضا المستفيدين",
 ("franchise","الأداء المالي"):"الأداء المالي للامتياز",("franchise","التشغيل والجودة"):"جودة وجاهزية تشغيل الامتياز",("franchise","تجربة العملاء والشركاء"):"تجربة عملاء الامتياز",("franchise","النمو والتوسع"):"نمو شبكة الامتياز",("franchise","المبيعات والأداء التجاري"):"مبيعات الامتياز التجاري",("franchise","استدامة الشراكة والامتثال"):"استدامة شراكات الامتياز",
 
 
 ("projects","تسليم محطات الشركة"):"تسليم محطات الشركة",("projects","الإشراف على الامتياز"):"الإشراف على تطوير الامتياز",("projects","الجودة والمقاولون"):"جودة المقاولين",("projects","الالتزام بالخطة"):"الالتزام بالميزانية والجدول",
 ("supplychain","خدمة العميل والتوفّر"):"توفّر الوقود وخدمة المحطات",("supplychain","المخزون"):"كفاءة المخزون",("supplychain","المشتريات"):"كفاءة المشتريات",("supplychain","التوريد والتسليم"):"التزام التوريد والتسليم",("supplychain","الموردون والرضا"):"إدارة الموردين والرضا",
 ("maintenance","جاهزية الأصول"):"جاهزية الأصول والصيانة الوقائية",("maintenance","الاستجابة والإصلاح"):"سرعة الاستجابة والإصلاح",("maintenance","موثوقية الأتمتة"):"موثوقية أنظمة الأتمتة",
 ("digital","توفّر واستقرار الأنظمة"):"توفّر واستقرار الأنظمة التقنية",("digital","الأمن والصلاحيات"):"الأمن السيبراني والصلاحيات",("digital","المشاريع التقنية"):"إنجاز المشاريع التقنية",("digital","الحوكمة والبيانات"):"حوكمة وتكامل البيانات",("digital","الصيانة والرضا"):"صيانة تقنية ورضا المستخدمين",
 ("hr","الامتثال والالتزام"):"الامتثال والتوطين",("hr","الاستقطاب"):"كفاءة الاستقطاب",("hr","التكلفة والرواتب"):"كفاءة التكلفة ودقة الرواتب",("hr","الاستقرار والتطوير"):"الاستقرار والتطوير",
 ("marketing","الاكتساب والعائد"):"الاكتساب والعائد التسويقي",("marketing","الوعي والوصول"):"الوعي والوصول",("marketing","التفاعل والمجتمع"):"التفاعل والمجتمع",("marketing","السمعة وتجربة العلامة"):"السمعة وتجربة العلامة",("marketing","نمو تطبيق درب"):"نمو تطبيق درب",
 ("quality","الزيارات الميدانية ورفع الملاحظات"):"الزيارات الميدانية ورفع الملاحظات",("quality","متابعة إغلاق الملاحظات والتحقق"):"متابعة إغلاق الملاحظات والتحقق",("quality","التدقيق الداخلي وعدم المطابقة"):"التدقيق الداخلي وعدم المطابقة",("quality","الإجراءات والسياسات والنماذج"):"الإجراءات والسياسات والنماذج",("quality","التحسين المستمر والتحليل"):"التحسين المستمر والتحليل",("quality","الرقمنة وجاهزية نظام الجودة"):"الرقمنة وجاهزية نظام الجودة",
 ("legal","التحقيق"):"كفاءة التحقيقات",("legal","أعمال العقود"):"جودة مراجعة العقود",("legal","أعمال القضايا"):"إدارة القضايا",("legal","الاستشارات القانونية"):"الاستشارات القانونية",
 ("finance","المالية الاستراتيجية"):"الأداء المالي الاستراتيجي",("finance","الذمم المدينة"):"التحصيل وإدارة المدينين",("finance","صناعة الوقود"):"دقة مخزون وتسويات الوقود",("finance","الذمم الدائنة"):"إدارة الدائنين",("finance","الموازنة والتقارير"):"انضباط الموازنة",("finance","السيولة ورأس المال"):"السيولة ورأس المال العامل",("finance","الخزينة واستثمار الفائض النقدي"):"الخزينة واستثمار الفائض النقدي"}
AXIS_NO_PARENT=set()   # محاور تبقى فرعياتها مستقلة بلا مؤشر أساسي
...
# ── تعريب نهائي: إزالة أي مصطلح لاتيني من كل خلية معروضة ومن أسماء الأوراق ──
import re as _re
_REPL=[
 ("ESG والاستدامة","الاستدامة والحوكمة"),
 ("Balanced Scorecard","بطاقة الأداء المتوازن"),
 ("أنظمة تقنية المعلومات (ERP/ITSM/SIEM)","أنظمة تقنية المعلومات (تخطيط الموارد وإدارة الخدمات ومراقبة الأمن)"),
 ("نظام إدارة الصيانة (CMMS) وأنظمة الأتمتة (SCADA)","نظام إدارة الصيانة وأنظمة الأتمتة الإشرافية"),
 ("ERP وPOS وCashIn وATG","تخطيط الموارد ونقاط البيع والكاش والقياس"),
 ("D365 FNO","نظام دايناميكس لتخطيط الموارد"),("D365","نظام دايناميكس"),
 ("مقياس eNPS","مقياس صافي ترشيح الموظفين"),
 ("E — البيئة","البيئة"),("S — الاجتماعي","الاجتماعي"),("G — الحوكمة","الحوكمة"),
 ("ضمن SLA","ضمن المدة المحددة"),(" SLA",""),(" SOPs",""),(" Fill Rate",""),
 ("ISO ","الأيزو "),("Google","قوقل"),("EBITDA","إبيتدا"),("Tatin","تاتين"),
 ("PMO","مكتب إدارة المشاريع"),("QMS","نظام إدارة الجودة"),
 ("SCADA","الأنظمة الإشرافية"),("CMMS","نظام إدارة الصيانة"),
 ("ITSM","إدارة الخدمات"),("SIEM","مراقبة الأمن"),("ERP","تخطيط الموارد"),
 ("CashIn","الكاش"),("POS","نقاط البيع"),("ATG","القياس"),
 ("BSC","بطاقة الأداء المتوازن"),("تانكي","درب"),("718.8M","718.8 مليون"),
 ("Top 5","أفضل 5"),("CSAT","رضا الشركاء"),("DSO","أيام التحصيل"),
 ("/Primavera"," وبريمافيرا"),("Primavera","بريمافيرا"),("TRIR","معدل الحوادث"),
]
_paren=_re.compile(r'\s*\([A-Za-z][^)]*\)')
def _arabize(v):
    for a,b in _REPL: v=v.replace(a,b)
    v=_paren.sub('',v)
    v=_re.sub(r' {2,}',' ',v).strip()
    return v
for _s in wb.worksheets:
    nt=_arabize(_s.title)
    if nt!=_s.title and nt and nt not in wb.sheetnames: _s.title=nt
