...
def main() -> None:
    ...
    # 1) قيمة النقطة 1,000:1 + معدلات الكسب — تنتشر لكل الأوراق عبر المعادلات
    S["C6"] = 1000          # 1,000 نقطة = ريال (بدل 10,000 لتفادي التضخيم المبالغ)
    S["C7"], S["C8"], S["C9"] = 5, 7.5, 10   # 0.5% / 0.75% / 1%
    # 2) هوامش درب الفعلية (~13 هللة/لتر)
    S["C26"], S["C27"] = 13, 13
    ...
    S["F32"] = ""
    S["A33"] = ("💡 الفلسفة · نقاط أكبر من ساسكو 12x–23x + قيمة استبدال واضحة "
                "(1,000 نقطة = ريال) دون تضخيم يكشف ضعف القيمة")
    ...
    M["D16"], M["E16"], M["F16"], M["G16"] = "5 نقطة", "7.5 نقطة", "10 نقطة", "12x - 23x"
    M["D18"], M["E18"], M["F18"], M["G18"] = "0.50%", "0.75%", "1.00%", "1.2x - 2.3x"
    M["D19"], M["E19"], M["F19"] = "500 نقطة", "750 نقطة", "1,000 نقطة"
    # التوصيات الاستراتيجية — مواءمة مع 1,000:1
    M["A23"] = "1. اعتمد نقاطاً أكبر من ساسكو (5 نقطة/ريال + 1,000 نقطة = ريال) دون مبالغة تكشف ضعف القيمة"
    M["A25"] = "3. هدية ترحيب 5,000 نقطة = 5 ريال · إحساس كبير وتكلفة بسيطة"
    M["A26"] = "4. التسويق: 'احصل على نقاط أضعاف ساسكو · 5 نقاط لكل ريال'"
    ...
    ext_inputs = [
        ...
        (38, "كسب الديزل (نقطة/ريال)", 2.5, "كاش باك 0.25%"),
        (39, "كسب الشركاء (نقطة/ريال)", 40, "~4% ممولة من الشريك"),
        (40, "مساهمة الشريك لدرب (هللة/ريال)", 1, "ما يدفعه الشريك مقابل عملاء درب"),
        (41, "هدية الترحيب الموصى بها (نقطة)", 5000, "= 5 ريال تكلفة فعلية"),
    ]
