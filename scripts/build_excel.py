...
def main() -> None:
    ...
    # 1) النموذج الشفّاف: كل ريال = نقطة · 100 نقطة = ريال (1%) — المستويات بالمنافع
    S["C6"] = 100           # 100 نقطة = ريال (النقطة = هللة)
    S["C7"], S["C8"], S["C9"] = 1, 1, 1   # 1% للجميع (تمييز المستويات بالمنافع)
    # 2) هوامش درب الفعلية (~13 هللة/لتر)
    S["C26"], S["C27"] = 13, 13
    ...
    S["F32"] = ""
    S["A33"] = ("💡 الفلسفة · نموذج شفّاف: كل ريال = نقطة · 100 نقطة = ريال (1% كاش باك) "
                "بلا تضخيم · ثقة كاملة كمنهج TotalEnergies")

    # 4) الملخص التنفيذي — الخلايا النصية الثابتة
    M = wb["الملخص التنفيذي"]
    M["A6"], M["D6"], M["G6"] = "1% من كل ريال إنفاق", "1% + منافع للأعضاء النشطين", "1% + منافع VIP"
    M["D16"], M["E16"], M["F16"], M["G16"] = "1 نقطة", "1 نقطة", "1 نقطة", "2.3x"
    M["D18"], M["E18"], M["F18"], M["G18"] = "1.00%", "1.00%", "1.00%", "2.3x"
    M["D19"], M["E19"], M["F19"] = "100 نقطة", "100 نقطة", "100 نقطة"
    # التوصيات الاستراتيجية — مواءمة مع النموذج الشفّاف
    M["A23"] = "1. اعتمد النموذج الشفّاف: كل ريال = نقطة · 100 نقطة = ريال (1%) — ثقة كاملة بلا تضخيم"
    M["A25"] = "3. هدية ترحيب 500 نقطة = 5 ريال · ترحيب بسيط وواضح"
    M["A26"] = "4. التسويق: 'كل ريال نقطة · ضعف ساسكو كاش باك'"
    ...
    ext_inputs = [
        ...
        (38, "كسب الديزل (نقطة/ريال)", 0.5, "كاش باك 0.5% (هامش ضعيف)"),
        (39, "كسب الشركاء (نقطة/ريال)", 4, "~4% ممولة من الشريك"),
        (40, "مساهمة الشريك لدرب (هللة/ريال)", 1, "ما يدفعه الشريك مقابل عملاء درب"),
        (41, "هدية الترحيب الموصى بها (نقطة)", 500, "= 5 ريال تكلفة فعلية"),
    ]
