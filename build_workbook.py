...
DIG=[  # إدارة التقنية — المصدر: IT Department KPIs (مشاريع تحول + كفاءة تشغيلية)
 ...
 ("مشاريع التحول","تطبيق الولاء (تانكي) في المحطات","محطة","↑","LAST",164,"164 محطة","int",PL_INNO,P_TECH),
 ...
 ("الكفاءة التشغيلية","تكامل تطبيق الولاء (المحطات)","محطة","↑","LAST",164,"164 محطة","int",PL_SUST,P_QUAL),
...
MKT=[  # إدارة التسويق — تُغلق فجوتَي «تطوير التصاميم والهوية» و«إطلاق مشاريع جديدة» (المصدر: منصة درب)
...
EXEC=[  # بطاقة أداء الإدارة التنفيذية — مؤشرات مؤسسية عليا بمدخلات يحدّدها/يدخلها القياديون
...
# الإدارات الأربع
DEPTS=[("الإدارة التنفيذية","الإدارة التنفيذية · المؤشرات","الإدارة التنفيذية · بطاقة الأداء المؤسسية 2026  (10 مؤشرات عليا) — مدخلات القيادة التنفيذية",EXEC),
       ("الامتياز التجاري","الامتياز · المؤشرات","إدارة الامتياز التجاري والمبيعات · مؤشرات الأداء 2026  (36 مؤشر / 8 محاور)",FRAN),
       ...
       ("التقنية الرقمية","التقنية الرقمية · المؤشرات","إدارة التقنية · مؤشرات الأداء 2026  (24 مؤشراً) — مشاريع التحول والكفاءة التشغيلية",DIG),
       ("الموارد البشرية","الموارد البشرية · المؤشرات","إدارة الموارد البشرية · مؤشرات الأداء 2026  (17 مؤشراً) — خطة العمل 2026",HR),
       ("التسويق","التسويق · المؤشرات","إدارة التسويق · مؤشرات الأداء 2026  (15 مؤشراً / 9 موظفين) — تطوير الهوية وزيادة الوصول",MKT)]
DEPT_RANGES=[]
...
PROJ=[
 ...
 (PL_INNO,P_NEW,"التسويق + العقار","المعارض · الاتفاقيات الاستراتيجية · الشراكات","ok"),
 (PL_INNO,P_DESIGN,"التسويق (الدعاية والإعلان)","التزام الهوية البصرية · جودة التصميم","ok"),
 ...
 (PL_INNO,P_TANKI,"التسويق (المنتج) + التقنية (التكامل)","وصول ومشاركات تانكي · تكامل المحطات","ok"),
...
style_cell(ws.cell(r,2,"✅ كل مشاريع الخارطة أصبحت مغطّاة بمؤشرات وإدارات مسؤولة (التقنية الرقمية + الموارد البشرية + التسويق) · لا فجوات."),f=font(11,True,WHITE),fillc="538135",align=right()); r+=1
for g in ["✅ تطوير التصاميم والهوية — يملكه التسويق (الدعاية والإعلان + التزام الهوية البصرية).",
          "✅ إطلاق مشاريع جديدة — يغذّيه التسويق (المعارض + الاتفاقيات الاستراتيجية) والعقار (الشراكات).",
          "📌 توصية: تثبيت خطوط الأساس 2025 والأوزان لكل مؤشر، وإدخال المُحقَّق الفعلي من منصة درب."]:
