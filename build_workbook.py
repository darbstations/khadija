...
DIG=[  # إدارة التقنية — مؤشرات أداء حقيقية (المشاريع في سجل المبادرات IT_PROJECTS)
...
IT_PROJECTS=[
 ("نظام أتمتة الكاش (Cash-In)",164,"محطة",59,0.36),("D365 FNO — المرحلة الأولى",5,"وحدة",3.5,0.70),
 ("D365 FNO — المرحلة الثانية",4,"وحدة",0,0.0),("D365 FNO — المرحلة الثالثة",2,"وحدة",0,0.0),
 ("تطبيق الامتياز مع واثق",1,"تطبيق",0,0.0),("ربط المحطات بوزارة الطاقة (ATJ)",164,"محطة",0,0.0),
 ("ربط الكاميرات بالمركز الرئيسي",164,"محطة",0,0.0),("تطبيق الولاء (تانكي) في المحطات",164,"محطة",0,0.0),
 ("منصة Tatin السحابية",164,"محطة",2,0.012),("إدارة العمليات بالذكاء الاصطناعي",164,"محطة",0,0.0),
]
...
DEPTS=[("الإدارة التنفيذية","الإدارة التنفيذية · المؤشرات","الإدارة التنفيذية · بطاقة الأداء المؤسسية 2026  (10 مؤشرات عليا) — مدخلات القيادة التنفيذية",EXEC),
       ...
       ("التقنية الرقمية","التقنية الرقمية · المؤشرات","إدارة التقنية · مؤشرات الأداء 2026  (9 مؤشرات) — المشاريع في سجل المبادرات",DIG),
...
# مشاريع التقنية (محوّلة من مؤشرات إلى سجل مبادرات — تغذّي مؤشر إنجاز المحفظة)
INIT+=[(nm+f"  ({done}/{qty} {qt} · {int(pct*100)}%)","الابتكار","التحول التقني","نسبة إنجاز محفظة مشاريع التحول الرقمي","إدارة التقنية") for (nm,qty,qt,done,pct) in IT_PROJECTS]
r=4
for i in range(len(INIT)+6):  # المبادرات + مشاريع التقنية + صفوف فارغة
