...
2. **دراسة وتحليل الموقع (نقطة البداية):** العميل، المدينة، النشاطات المناسبة،
   منتجات الوقود، عملاء الشركات، العروض — [منهجية الدراسة](site-study.md).
3. **خط الأساس والتحليل:** المؤشرات الحالية + SWOT.
