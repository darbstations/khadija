...
DEPT_WEIGHTS = {
  "exec": 0.00, "franchise": 0.20, "operations": 0.18, "investment": 0.16,
  "realestate": 0.14, "quality": 0.08, "marketing": 0.09, "digital": 0.08, "hr": 0.07,
}
...
QUALITY=[  # إدارة الجودة — المصدر: ملف مؤشرات إدارة الجودة (القائمة المعتمدة، 15 مؤشراً)
 ("جودة المحطات والتشغيل","نسبة الالتزام العام بمعايير الجودة في المحطات","%","↑","AVG",0.90,"≥ 90%","pct",PL_SUST,P_QUAL),
