...
FLEET_CUT = 0.02         # عتبة شريحة الأساطيل — سبعة أضعاف وسيط الشبكة ٠٫٢٩٪
                         #   كانت ١٠٪ على مقياسٍ يضمّ جهاز نقاط البيع فينتفخ خمسة
                         #   أضعاف؛ أُعيدت معايرتها على المقياس المصحَّح والشريحة
                         #   تبقى ست محطات كما كانت
VAT = 1.15
...
SEGDEF = {
    ...
    "الأساطيل التجارية": ("Fleet / Commercial", "تطبيقات الأسطول ٢٪ فأكثر",
...
def segment(r):
    ...
    if r["fleet"] >= FLEET_CUT: return SEGS[1]
