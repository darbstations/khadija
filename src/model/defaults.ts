...
export const TIER_PERKS = [
  { key: "white", emoji: "🤍", label: "الأبيض", perks: ["كاش باك 0.5%", "استبدال فوري", "دعم فني (للجميع)", "خصومات شركاء تصل 15%", "عروض خارجية أساسية"] },
  { key: "silver", emoji: "🩶", label: "الفضي", perks: ["كل مزايا الأبيض", "نقاط مضاعفة ×1.5 بالمناسبات", "خصومات شركاء تصل 30%", "عروض خارجية أوسع", "إهداء نقاط للعائلة (محدود)"] },
  { key: "orange", emoji: "🟠", label: "البرتقالي", perks: ["كل مزايا الفضي", "نقاط مضاعفة ×2", "خصومات شركاء تصل 50%", "خصم على باقات درب", "عروض خارجية حصرية (بريميوم)", "أولوية وصول مبكر للعروض المحدودة", "مكافأة ولاء سنوية عند التجديد"] },
...
export const REDEMPTION_CATALOG = [
  ...
  { group: "🟠 قسائم خارجية (بخصم جملة)", cost: "95–97%", items: ["جرير · أمازون · نون", "كروت شحن اتصالات (STC/Mobily/Zain)", "اشتراكات رقمية (شاهد/أنغامي)"] },
  { group: "🟣 تحويل / تحالف", cost: "حسب الاتفاق", items: ["أميال طيران / قطاف", "إهداء النقاط للعائلة"] },
  { group: "🔴 تحفيزي (بلا نقاط)", cost: "تسويقية", items: ["سحب مجاني على جوائز كبرى (دخول مجاني · بلا نقاط)", "تبرّع خيري"] },
];

/** السحب المجاني — دخول مجاني بلا نقاط (لا مقابل مدفوع → حلال) · تموّله درب تسويقياً */
export const DRAW_PRIZES = [
  { icon: "🚗", name: "سيارة (تويوتا)", value: 90000 },
  { icon: "📱", name: "آيفون", value: 5000 },
  { icon: "🏍️", name: "سكوتر", value: 8000 },
  { icon: "⌚", name: "ساعة ذكية", value: 1500 },
];
