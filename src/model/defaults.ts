...
export const TIER_PERKS = [
  ...
  { key: "silver", emoji: "🩶", label: "الفضي", perks: ["كل مزايا الأبيض", "نقاط مضاعفة ×1.5 بالمناسبات", "خصومات شركاء أكبر", "أولوية دعم فني"] },
  { key: "orange", emoji: "🟠", label: "البرتقالي", perks: ["كل مزايا الفضي", "نقاط مضاعفة ×2", "وصول VIP لفعاليات درب", "خصم على باقات درب", "مدير علاقة"] },
];
