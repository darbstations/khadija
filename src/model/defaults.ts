...
export const TIER_PERKS = [
  { key: "white", emoji: "🤍", label: "الأبيض", perks: ["كاش باك 0.5%", "استبدال فوري للعروض", "عروض المتاجر الأساسية"] },
  { key: "silver", emoji: "🩶", label: "الفضي", perks: ["كل مزايا الأبيض", "نقاط مضاعفة ×1.5 بالمناسبات", "خصومات شركاء 10%", "أولوية دعم فني", "إهداء نقاط للعائلة (محدود)"] },
  { key: "orange", emoji: "🟠", label: "البرتقالي", perks: ["كل مزايا الفضي", "نقاط مضاعفة ×2", "وصول VIP لفعاليات درب", "خصومات شركاء 15%", "خصم على باقات درب", "أولوية وصول مبكر للعروض المحدودة", "دعم مخصّص عبر التطبيق (كونسيرج)", "مكافأة ولاء سنوية عند التجديد"] },
